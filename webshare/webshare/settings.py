...
DATABASES = {
    'default': {
        ...
        'CLIENT': {
            ...
            # 'username': 'your_username',  # Optional: MongoDB username
            # 'password': 'your_password',  # Optional: MongoDB password
            # 'authSource': 'admin',  # Optional: Database for authentication (default 'admin')
